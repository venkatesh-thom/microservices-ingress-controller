pipeline {
    ...
    environment {
        DOCKER_HUB_REPO = 'venkatesh990/techsolutions-app'
    ...
    stages {
        stage('Checkout') {
            steps {
                ...
                git 'https://github.com/venkatesh-thom/microservices-ingress-controller.git'
            }
        }
        ...
        stage('Deploy to Kubernetes') {
            steps {
                ...
                script {
                    withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-creds']]) {
                        sh "sed -i 's|venkatesh990/techsolutions-app:latest|venkatesh990/techsolutions-app:${env.IMAGE_TAG}|g' k8s/deployment.yaml"
